...
export default function MiniLineChart({ data, color = '#3a598f', height = 96, valueFormatter }: Props) {
  ...
  return (
    <div className="relative w-full" style={{ height }}>
      ...
      >
        <line x1={padX} y1={padTop + plotH} x2={width - padX} y2={padTop + plotH} stroke="#ccd6e6" strokeWidth={1} />
        ...
        {points.map((p, i) => {
          ...
          return (
            <text key={i} x={p.x} y={height - 4} fontSize={9} fill="#5b7196" textAnchor="middle">
              {p.label}
            </text>
          );
        })}
